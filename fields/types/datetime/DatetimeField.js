...
module.exports = Field.create({
	...
	parseFormats: ['YYYY-MM-DD', 'YYYY-MM-DD h:m:s a', 'YYYY-MM-DD h:m a', 'YYYY-MM-DD H:m:s', 'YYYY-MM-DD H:m' , , 'YYYY-MM-DD HHmm'],
		...
		if (this.shouldRenderField()) {
			input = (
				<InputGroup>
					...
					<InputGroup.Section grow>
						<FormInput name={this.props.paths.time} value={this.state.timeValue} placeholder="HHMM" onChange={this.timeChanged} autoComplete="off" />
					</InputGroup.Section>
					<InputGroup.Section>
